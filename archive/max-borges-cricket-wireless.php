...
<head>
	...
	<title>Max Borges — Cricket Wireless</title>
	<?php include '../includes/link.php';?>
</head>
<body>
	<h1 style="display:none;">Case Study — Cricket Wireless</h1>
			...
			<div class="container">
    			<div class="row">
					<div class="col-md-6 col-md-offset-3">
        				<h1>Max Borges — Cricket Wireless Case Study</h1>
        				<h2>We’re here with a reliable network</h2>
                   		<p><strong>At Cricket Wireless everything they do makes it easier for everyone to connect</strong>. They cover 99% of Americans by providing affordable cell phones and plans that run on a high quality realiable network.</p>
						<p>The relationship cultivating strategy kicks off by generating awareness and top-level education about products. The next interest phase cues people and potential customers into what the company stands for and who they are. Media personalities and influencers continue to cultivate and validate the brand in the next phase, eventually leading to a sale. Post sale—the relationship continues to grow as users become advocates.</p>
  					</div>
                </div>
 			</div>
		</div>
	...
	<main>
	<section>
		<h2>Cricket Wireless Case Study</h2>
		<article>
    		<div class="jumbotron" id="aee-blue">
    			<div class="container-fluid">
        			<div class="row">
                    	<img src="../images/max-borges-cricket-wireless-0939.png" alt="Advanced Energy Economy Brand and Style Guide" class="img-responsive">
                  	</div>
      			</div>
    		</div>
    		<div class="container">
    		...
    		<div class="container">
      			<div class="row">
        			<div class="col-md-6 col-md-offset-3" id="description">
						...
						<p>We implemented newly established brand guidelines to define and apply consistent visual hierarchies and styles to reports. Covers communicate the subject of the complex reports in a single image. By using a grid system and dynamically linking text to design files, the annual and semi-annual reports were seamlessly designed and produced. The powerful imagery and iconography create a visual message that accelerates the transition to an advanced energy economy.</p>
    		...
    		<div class="container">
      			<div class="row">
        			<div class="col-md-6 col-md-offset-3" id="description">
          				...
          				<p>Advanced Energy Economy initiative leads present data and reports to companies and legislatures across all levels of government. Infographics were created to present complex information and tell the story behind the energy data in an easily understandable way.</p>
						<p>We distilled complex data down to identify key messaging. The resulting visuals were designed to support arguments that move executives and government officials to action.</p>
