    		...
    		<div class="container">
      			<div class="row">
        			<div class="col-md-6 col-md-offset-3" id="description">
          				<h3>Inspiration</h3>
						<p>The action or power of moving the intellect or emotions, and influencing or suggesting opinions, drawing in specifically, quality or state of being inspired, something that is motivated, an inspiring agent or influence.</p>
      			</div>
    		</div>
  		</article>
    		...
    		<div class="container">
      			<div class="row">
        			<div class="col-md-6 col-md-offset-3" id="description">
						...
						<p>The process of composition is the most crucial step in visual problem-solving. The result of the compositional decisions set the purpose and meaning of the visual statement and carry strong implications for what the viewer receives. It is at this vital stage in the creative process that the visual communicator has the strongest control of the work and the greatest opportunity to express the total mood of the work is intended to convey. But the visual mode offers no proscribed structural systems that are absolute. How can we gain control of our complex visual means with some certainty of shared meaning in the final result? In language, syntax means the orderly arrangement of words in their appropriate form and order. The rules are defined: all one has to do is learn them and use them intelligently. But syntax in the context of visual literacy can only mean the orderly arrangement of parts, leaving us with the problem of how we can approach the process of composition with intelligence and know of how compositional decisions will affect the final result. There are no absolute rules, but there is a great deal of understanding of what will occur in terms of meaning if we maker certain arrangement of the parts toward organizing and orchestrating the visual means. Many of the guidelines for understanding the meaning in visual form, the syntactical potential of structure in visual literacy, stem from the investigation of the process of human perception. </p>
                    </div>
      			</div>
    		</div>
  		</article>
		...
		<h2>Dancing Queen</h2>
    		...
    		<div class="container">
      			<div class="row">
        			<div class="col-md-6 col-md-offset-3" id="description">
          				<h3>Composition: The syntactical guidelines for visual literacy</h3>
