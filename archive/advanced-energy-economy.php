			...
			<div class="container">
    			<div class="row">
					<div class="col-md-6 col-md-offset-3">
						...
						<h2>Creative Director (2013-2016)</h2>
                   		<p>Developed design guidelines and directed creative work, including printed collateral, websites, and email campaigns. Played an essential role in the marketing, communications, and digital departments to maximize the talents of copywriters, web developers, initiative leads, and other creatives.</p>
  					</div>
                </div>
 			</div>
		</div>
