...
<body>
	...
	<section>
  		...
  		<article>
    		<div class="jumbotron" id="chronicle-blue">
      			<div class="container-fluid">
        			<div class="row">
                    	<img src="images/goodnight-construction-site.png" class="img-responsive">
                    </div>
      			</div>
    		</div>
    		<div class="container">
      			<div class="row">
            		<img src="images/chevron-up.png"  alt="Goodnight, Goodnight Construction Site ebook" class="img-responsive">
        			<div class="col-md-6 col-md-offset-3" id="description">
          				<h3>Goodnight, Goodnight Construction Site</h3>
          				<p>As the sun sets behind the big construction site, all the hardworking trucks get ready to say goodnight. One by one, Crane Truck, Cement Mixer, Dump Truck, Bulldozer, and Excavator finish their work and lie down to rest—so they'll be ready for another day of rough and tough construction play! With irresistible artwork by best-selling illustrator Tom Lichtenheld and sweet, rhyming text, this book will have truck lovers of all ages begging for more.</p>
        				<h6><small>(src. <a href="http://www.chroniclebooks.com/titles/goodnight-goodnight-construction-site.html" target="_blank">Chronicle Books</a>)</small></h6>
                    </div>
      			</div>
    		</div>
  		</article>
    ...
    <section>
  		...
  		<article>
    		<div class="jumbotron">
      			<div class="container">
        			<div class="col-md-6" id="loud-dog-red">
    ...
    <section>
  		...
  		<article>
    		<div class="jumbotron">
      			<div class="container">
        			<div class="col-md-6" id="griffith-red">
                    	<img src="images/hurry-kiki-hurry.png" class="img-responsive">
                   	</div>
                    <div class="col-md-5 col-md-offset-1">
                    	<h3>Films, posters, and artwork from post-graduate work</h3>
        			</div>
      			</div>
    		</div>
  		</article>
        ...
        <section>
  		...
  		<article>
    		<div class="jumbotron">
      			<div class="container">
        			<div class="col-md-6" id="websites-04">
                    	<img src="images/websites-2004.png" class="img-responsive">
                   	</div>
                    <div class="col-md-5 col-md-offset-1">
                    	<h3>Websites and landing pages from the turn of the millennium</h3>
        			</div>
      			</div>
    		</div>
  		</article>
