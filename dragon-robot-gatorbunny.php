...
<body>
	...
	<section>
  		...
  		<article>
    		...
    		<div class="container">
      			<div class="row">
                	<img src="images/dapper-griffin.png"  alt="Dapper Griffin" class="img-responsive">
        			<div class="col-md-6 col-md-offset-3" id="description">
          				<h3>Dragon, Robot, Gatorbunny</h3>
                        <p>Using multi-touch gestures children were encouraged to stretch, sketch, and doodle with brushes to create beetle cats, dog snails, dapper griffins, or whatever they could imagine!
        			</div>
      			</div>
    		</div>
  		</article>
