...
<main>
	...
	<h2>Advanced Energy Economy</h2>
        ...
        <div class="container">
            	<div class="col-md-6 col-md-offset-3">
                <p><h3>Advanced Energy Economy&nbsp;Reports</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
				</div>
       	</div>     
    	</article>
    	<article>
        ...
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
            <p><h3>Ohio's Electricity Future Report</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
			</div>
       	</div>     
		</article>
    	<article>
        ...
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
            <p><h3>AEE and AEE Institue Infographics</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
			</div>
       	</div> 
		</article>
    	<article>
        ...
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
            <p><h3>Advanced Energy Economy&nbsp;Letterhead</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
			</div>
       	</div> 
    	</article>
	</section>
    ...
    <h2>Gap Old Navy</h2>
    	...
    	<div class="jumbotron" id="old-navy-blue">
    		<div class="container-fluid">
  				<div class="row"><img src="images/gap-old-navy-email.png" alt="Old Navy Online Email Campaigns" class="img-responsive"></div>
        	</div>
  		</div>
        <div class="container">
            	<div class="col-md-6 col-md-offset-3">
                <p><h3>Online Email Campaigns</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
				</div>
       	</div>   
    	</article>
	</section>
    ...
    <h2>Dictionary.com</h2>
        ...
        <div class="jumbotron" id="dictionary-blue">
  			<div class="container-fluid">
            	<div class="row"><img src="images/dictionary.png" class="img-responsive" alt="Dictionary.com Search Results Redesign"></div>
           	</div>
     	</div>
        <div class="container">
            	<div class="col-md-6 col-md-offset-3">
                <p><h3>Hyperbole Search Results&nbsp;Design</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
				</div>
       	</div>   
        </article>
	</section>
	...
	<h2>Chronicle Books</h2>
        ...
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
           	<p><h3>It's A Tiger</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
			</div>
       	</div>   
        </article>
        <article>
        <div class="jumbotron" id="chronicle-blue">
  			<div class="container-fluid">
        		<div class="row"><img src="images/trueblood.png" class="img-responsive"></div>
            </div>
        </div>
        <div class="container">
           	<div class="col-md-6 col-md-offset-3">
            <p><h3>TrueBlood Cookbook</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
			</div>
       	</div> 
        </article>
        <article>
        ...
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
            <p><h3>Goodnight, Goodnight, Construction Site</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
			</div>
       	</div> 
        </article>
        <article>
        ...
        <article>
  		<div class="jumbotron" id="chronicle-blue">
        	<div class="container-fluid">
	        	<div class="row"><img src="images/the-ultimate-metallica.png" class="img-responsive"></div>
            </div>
       	</div>
        <div class="container">
           	<div class="col-md-6 col-md-offset-3">
            <p><h3>The Ultimate Metallica</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
			</div>
       	</div> 
        </article>
        <article>
        ...
        <div class="container">
            	<div class="col-md-6 col-md-offset-3">
                <p><h3>The History Of Surfing</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
				</div>
       	</div> 
        </article>
	</section>
	<section>
  	<h2>TRX | Fitness Anywhere</h2>
        ...
        <div class="container">
            	<div class="col-md-6 col-md-offset-3">
                <p><h3>Website, Application, and Experience Design</h3>These concepts were inspired and based on the MLB logo abd the idea of rally caps. The use and treatment of the wings breaks the style guide provided. The logos could be printed on the insides of hats and participants could be encouraged to wear or turned inside rally hats. The three concepts play with various states of the logo.</p>
				</div>
       	</div> 
        </article>
  	</section>
    	...
    	<div class="container-fluid">
        	<div class="row text-muted">
        		...
        		Top Pot Hand-Forged Doughnuts
      			...
      			Award for Individual Excellence and Highly Commended Editing</p>
    			</div>
    			<div class="col-md-6">
      			<p><h3>Experience</h3>
