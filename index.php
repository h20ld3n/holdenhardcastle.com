...
<main>
  <section>
    ...
    <article>
      <div class="jumbotron" id="aee-blue">
        <div class="container-fluid">
          <div class="row"> <img src="images/aee-initiatives.png"  alt="Advanced Energy Economy & AEE Institute Reports" class="img-responsive"> </div>
        </div>
      </div>
      <div class="container">
      ...
      <div class="container">
        <div class="row"> <img src="images/chevron-up.png"  alt="Advanced Energy Economy & AEE Institute Reports" class="img-responsive">
          <div class="col-md-6 col-md-offset-3" id="description">
            ...
            <p>Worked with Creative and Marketing Directors, Editors, Copy Writers, and other Designers at Old Navy to create and support online and email marketing campaigns.</p>
          </div>
        </div>
      </div>
    </article>
      ...
      <div class="container">
        <div class="row"> <img src="images/chevron-up.png"  alt="Advanced Energy Economy & AEE Institute Reports" class="img-responsive">
          <div class="col-md-6 col-md-offset-3" id="description">
            ...
            <p>A re-design of dictionary.com's search result page (i.e word definition results page) for the word "hyperbole". The page was given a modern responsive design, that adjusts to widescreen monitors, iPads and iPhones, and effectively integrates advertising and promotions in a way that is not intrusive.</p>
          </div>
        </div>
      </div>
    </article>
  ...
  <section>
      ...
      <div class="container">
        <div class="row"> <img src="images/chevron-up.png"  alt="Advanced Energy Economy & AEE Institute Reports" class="img-responsive">
          <div class="col-md-6 col-md-offset-3" id="description">
            ...
            <p>Worked with legendary music photographer Ross Halfin, as well as editors and designers to ensure that the candid photographs in the physical book were portrayed and re-cropped to ensure original intentions were translated for the various devices.</p>
          </div>
        </div>
      </div>
    </article>
    <article>
      <div class="jumbotron" id="chronicle-blue">
        <div class="container-fluid">
          <div class="row"> <img src="images/history-of-surfing.png" class="img-responsive"> </div>
        </div>
      </div>
      <div class="container">
        <div class="row"> <img src="images/chevron-up.png"  alt="Advanced Energy Economy & AEE Institute Reports" class="img-responsive">
  ...
  <section>
    ...
    <article>
      <div class="jumbotron" id="trx-bg">
        <div class="container-fluid">
          <div class="row"> <img src="images/trx-drew-brees-app.png" class="img-responsive"> </div>
        </div>
      </div>
      <div class="container">
        <div class="row"> <img src="images/chevron-up.png"  alt="Advanced Energy Economy & AEE Institute Reports" class="img-responsive">
