...
<section class="container">
  <div class="row">
    <div class="col-md-12"> <img src="images/cbs-mktw-check.jpg" class="img-responsive">
      <h2 id="what"></h2>
    </div>
  </div>
</section>
...
<section class="container">
  <div class="row">
    <div class="col-md-12"> <img src="images/cbs-mktw-shark.jpg" class="img-responsive">
      <h2 id="what"></h2>
    </div>
  </div>
</section>
...
<section class="container">
  <div class="row">
    <div class="col-md-12"> <img src="images/cbs-mktw-behind-the-numbers.jpg" class="img-responsive">
      <h2 id="what"></h2>
    </div>
  </div>
</section>
...
<section class="jumbotron"> 
  ...
  <div id="odu-theatre-of-the-absurd" class="carousel slide" data-ride="carousel"> 
    ...
    <!-- Wrapper for slides -->
    <div class="carousel-inner" role="listbox">
      <div class="item active"> <img src="images/theatre-of-the-absurd-bald-soprano.jpg" alt="..."> </div>
      <div class="item"> <img class="col-md-9" src="images/theatre-of-the-absurd-waiting-for-godot.jpg" alt="..."> <span class="col-md-3">
        <h3>Theatre of the Absurd&nbsp;Posters</h3>
    ...
    <!-- Controls --> 
    <a class="left carousel-control" href="#odu-theatre-of-the-absurd" role="button" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <span class="sr-only">Previous</span> </a> <a class="right carousel-control" href="#odu-theatre-of-the-absurd" role="button" data-slide="next"> <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> <span class="sr-only">Next</span> </a> </div>
</section>
<section class="container">
